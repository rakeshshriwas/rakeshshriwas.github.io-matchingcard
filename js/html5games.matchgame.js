...
$(function() {
  ...
  if (savedObject != undefined) {
    ...
    for (var i in matchingGame.savingObject.removedCards) {
      $(
        ".card[data-card-index=" +
          matchingGame.savingObject.removedCards[i] +
          "]"
      ).remove();
    }
  }
  ...
  if (savedObject != undefined) {
    ...
    matchingGame.savingObject.currentElapsedTime =
      savedObject.currentElapsedTime;
  }
...
function hideShowPopup() {
  ...
  if (x.style.display === "none") {
    ...
    // document.getElementById("howtoplay-box").focus();
...
function hideShowEarnLifePopup() {
  var earnLife = document.getElementById("earnLife");
  if (earnLife.style.display === "none") {
    earnLife.style.display = "block";
  } else {
    earnLife.style.display = "none";
    // document.getElementById("body").focus();
  }
}
$(document).ready(function() {
    ...
    if (e.keyCode == 27) {
      ...
      if (checkDisplay("#playGame")) {
        ...
        $("input#start-btn")
          .addClass("focused")
          .focus();
      } else if (checkDisplay("#howtoplay")) {
        $("#howtoplay").css("display", "none");
        $("input#how-to-play")
          .addClass("focused")
          .focus();
      } else if (checkDisplay("#earnLife")) {
        console.log("Display is NOT Block");
        $("#earnLife").css("display", "none");
        $("input#earn-life")
          .addClass("focused")
          .focus();
      }
  ...
  $("#earnLife").keypress(function(e) {
    if (e.keyCode == 13) {
      console.log("Enter");
      hideShowEarnLifePopup();
      $("input#earn-life")
        .addClass("focused")
        .focus();
    }
...
$(document).keydown(function(e) {
  if (e.keyCode == 38) {
    ...
    if (
      ...
      //If it is not the first, focus the prev
      $("input.focused")
        .removeClass("focused")
        .parents(".bloc")
        .prev(".bloc")
      ...
      //If it is the first, focus the last
      var nbOfBlocs = $(".bloc").length;
      $("#step").html(nbOfBlocs);
      $("input#text" + nbOfBlocs)
        .addClass("focused")
        .focus();
    }
  }
  if (e.keyCode == 40) {
    ...
    if (
      ...
      //If it is not the last, focus the next
      $("input.focused")
        .removeClass("focused")
        .parents(".bloc")
        .next(".bloc")
